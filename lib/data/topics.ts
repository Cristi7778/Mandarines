...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    items: [
      ...
      it('t9bi6',  'topic-9b', '表弟', 'biǎodì',  'younger male cousin (maternal side)', '我',   '在上小学。',   'My younger (maternal) cousin is in primary school.'),
      it('t9bi7',  'topic-9b', '表姐', 'biǎojiě', 'older female cousin (maternal side)', '我',   '已经工作了。', 'My older (maternal) female cousin is already working.'),
      it('t9bi8',  'topic-9b', '表妹', 'biǎomèi', 'younger female cousin (maternal side)','我',  '很可爱。',     'My younger (maternal) female cousin is very cute.'),
      it('t9bi9',  'topic-9b', '堂哥', 'tánggē',  'older male cousin (paternal side)',   '我',   '和我一起长大。','My (paternal) older cousin and I grew up together.'),
      it('t9bi10', 'topic-9b', '堂弟', 'tángdì',  'younger male cousin (paternal side)', '我',   '很调皮。',     'My younger (paternal) male cousin is very mischievous.'),
      it('t9bi11', 'topic-9b', '堂姐', 'tángjiě', 'older female cousin (paternal side)', '我',   '是护士。',     'My older (paternal) female cousin is a nurse.'),
      it('t9bi12', 'topic-9b', '堂妹', 'tángmèi', 'younger female cousin (paternal side)','我',  '学钢琴。',     'My younger (paternal) female cousin learns piano.'),
    ],
  },
  {
    id: 'topic-11',
